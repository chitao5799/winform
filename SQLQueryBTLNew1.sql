...
select maSV,tenSV,ngaySinh,gioiTinh,diaChi,sv.soDienThoai,email,maLopHC_FK,namNhapHocCuaSV,tenKhoa
from SinhVien sv,LopHanhChinh lhc, Khoa
where sv.maLopHC_FK=lhc.maLopHC and lhc.maKhoaFK= Khoa.maKhoa and maKhoa =N'0001'

--tìm sinh viên theo lớp hc (và khoa)
select maSV,tenSV,ngaySinh,gioiTinh,diaChi,sv.soDienThoai,email,maLopHC_FK,namNhapHocCuaSV,tenKhoa
from SinhVien sv,LopHanhChinh lhc, Khoa
where sv.maLopHC_FK=lhc.maLopHC and lhc.maKhoaFK= Khoa.maKhoa and lhc.maLopHC=N'1710A02' --and khoa.maKhoa=N'0001'

select maSV,tenSV,ngaySinh,gioiTinh,diaChi,sv.soDienThoai,email,maLopHC_FK,namNhapHocCuaSV,tenKhoa
from SinhVien sv,LopHanhChinh lhc, Khoa
where sv.maLopHC_FK=lhc.maLopHC and lhc.maKhoaFK= Khoa.maKhoa and tenSV like N'%t%'
--tìm sv theo tên + lớp + khoa
select maSV,tenSV,ngaySinh,gioiTinh,diaChi,sv.soDienThoai,email,maLopHC_FK,namNhapHocCuaSV,tenKhoa
from SinhVien sv,LopHanhChinh lhc, Khoa
where sv.maLopHC_FK=lhc.maLopHC and lhc.maKhoaFK= Khoa.maKhoa and sv.maLopHC_FK=N'1710A02' and maKhoa=N'0001' and tenSV like N'%t%'
...
as
begin
	select maSV,tenSV,sv.ngaySinh,sv.gioiTinh,sv.diaChi,sv.soDienThoai,sv.email,maLopHC_FK,namNhapHocCuaSV,tenGV
	from SinhVien sv,LopHanhChinh lhc,GiangVien gv
	where sv.maLopHC_FK=lhc.maLopHC and lhc.maGVChuNhiemFK=gv.maGV and maLopHC_FK=@malop
end
...
as
begin
select maLopTC,hocKy,namHoc,maGiangVienFK,tenGV,tenMon,soTinChi,tenKhoa
from LopTinChi inner join MonHoc on  LopTinChi.maMonFK=MonHoc.maMon 
				inner join GiangVien on LopTinChi.maGiangVienFK=GiangVien.maGV,Khoa
where hocKy=@hocky and namHoc like @namhoc and LopTinChi.maKhoaFK=@makhoa and LopTinChi.maKhoaFK=Khoa.maKhoa
end

exec dsLopTCHocKy 1,N'2019-2020',N'0002'
drop proc dsLopTCHocKy
...
select diemTBC,soTinChi-- maSV,diemChuyenCan,diemGiuaKy,diemThi,maLopTC_PK,tenMon,ltc.hocKy,ltc.namHoc,
